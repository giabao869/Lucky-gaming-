...
local Window = OrionLib:MakeWindow({Name = "Lucky Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Lucky Hub"})

OrionLib:MakeNotification({
	Name = "Lucky Hub",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://136573518692872",
	Time = 7
})
